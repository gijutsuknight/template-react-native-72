# Template React Native 72

A React Native 0.72 template project for quick setup and reference.

## How this template was created

```bash
npx @react-native-community/cli init TemplateReactNative72 --version 0.72 --package-name template.reactnative.v72
```
